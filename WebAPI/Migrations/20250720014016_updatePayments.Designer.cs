...
namespace WebAPI.Migrations
{
    ...
    [Migration("20250720014016_updatePayments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAPI.Models.CustomerInvoicePayment", b =>
                {
                    b.Property<Guid>("CustomerInvoicePaymentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebAPI.Models.CustomerInvoicePayment", b =>
                {
                    b.HasOne("CustomerInvoice", "CustomerInvoice")
                        .WithMany("CustomerInvoicePayments")
                        .HasForeignKey("CustomerInvoiceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("CustomerInvoice", b =>
                {
                    ...
                    b.Navigation("CustomerInvoicePayments");
                });
